...
import { createProfile, getProfile } from '../../actions/actionCreators/profiles';
    ...
    useEffect(()=>{
        ...
        if(profile !== null){
            setFormData({
                ...
                twitter: loading || !profile.data.socials ? '' : profile.data.socials.twitter && profile.data.socials.twitter,
                youtube: loading || !profile.data.socials ? '' : profile.data.socials.youtube && profile.data.socials.youtube,
                facebook: loading || !profile.data.socials ? '' : profile.data.socials.facebook && profile.data.socials.facebook,
                linkedin: loading || !profile.data.socials ? '' : profile.data.socials.linkedin && profile.data.socials.linkedin,
                instagram: loading || !profile.data.socials ? '' : profile.data.socials.instagram && profile.data.socials.instagram
                    })
        }
